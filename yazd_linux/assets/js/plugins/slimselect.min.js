    ...
    class l {
        ...
        setSelectedBy(t, e) {
            ...
            for (let o of this.data) {
                if (o instanceof n)
                    for (let n of o.options) s || (s = n), n.selected = !i && e.includes(n[t]), n.selected && (l.push(n), "single" === this.selectType && (i = !0));
        ...
        getOptgroupByID(t) {
            for (let e of this.data)
                if (e instanceof n && e.id === t) return e;
            return null
        }
        getOptionByID(t) {
        ...
        getFirstOption() {
            let t = null;
            for (let e of this.data)
                if (e instanceof n ? t = e.options[0] : e instanceof a && (t = e), t) break;
            return t
        }
        search(t, e) {
    ...
    class o {
        ...
        updateClassStyles() {
            if (this.main.main.className = "", this.main.main.removeAttribute("style"), this.content.main.className = "", this.content.main.removeAttribute("style"), this.main.main.classList.add(this.classes.main), this.content.main.classList.add(this.classes.content), "" !== this.settings.style && (this.main.main.style.cssText = this.settings.style, this.content.main.style.cssText = this.settings.style), this.settings.class.length)
                for (const t of this.settings.class) "" !== t.trim() && (this.main.main.classList.add(t.trim()), this.content.main.classList.add(t.trim()));
            ...
            if (s.classList.add(this.classes.valueText), s.textContent = t.text, e.appendChild(s), !t.mandatory) {
                ...
                s.classList.add(this.classes.valueDelete), s.onclick = e => {
                    ...
                    if (!(this.settings.minSelected && l.length < this.settings.minSelected) && (this.callbacks.beforeChange && (s = !0 === this.callbacks.beforeChange(l, i)), s)) {
                        ...
                        for (const e of l) {
                            if (e instanceof n)
                                for (const s of e.options) t.push(s.id);
            ...
            for (const n of t) {
                if (n.target === this.select && ("disabled" === n.attributeName && (s = !0), "class" === n.attributeName && (e = !0), "childList" === n.type)) {
                    for (const t of n.addedNodes)
                        if ("OPTION" === t.nodeName && t.value === this.select.value) {
...
class h {
    constructor(t) {
        ...
        this.focusSearch = void 0 === t.focusSearch || t.focusSearch, 
        this.ariaLabel = t.ariaLabel || "جعبه ترکیبی", 
        this.searchPlaceholder = t.searchPlaceholder || "جستجو", 
        this.searchText = t.searchText || "بدون نتیجه", 
        this.searchingText = t.searchingText || "در حال جستجو...", 
        this.searchHighlight = void 0 !== t.searchHighlight && t.searchHighlight, 
        ...
        this.placeholderText = void 0 !== t.placeholderText ? t.placeholderText : "مقدار را انتخاب کنید", 
        ...
        this.showOptionTooltips = void 0 !== t.showOptionTooltips && t.showOptionTooltips, 
        ...
        this.maxValuesMessage = t.maxValuesMessage || "{number} انتخاب شده", 
        this.addableText = t.addableText || 'برای افزودن {value} کلید "Enter" را فشار دهید'
    }
}
    return class {
        constructor(e) {
        ...
        setSelected(t, e = !0) {
            ...
            const a = [];
            for (const e of t)
                if (n.find((t => t.id == e))) a.push(e);
                else
                    for (const t of n.filter((t => t.value == e))) a.push(t.id);
