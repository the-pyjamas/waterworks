...
! function(e, t) {
    ...
    var ce, fe, de = function(e, t) {
        ...
        Ae = {
            ...
            labelIdle: ['فایل‌های خود را بکشید و رها کنید یا<span class="filepond--label-action"> جستجو </span>', ge.STRING],
            labelInvalidField: ["فیلد شامل فایل‌های نامعتبر است", ge.STRING],
            labelFileWaitingForSize: ["در انتظار اندازه", ge.STRING],
            labelFileSizeNotAvailable: ["اندازه در دسترس نیست", ge.STRING],
            labelFileCountSingular: ["فایل در لیست", ge.STRING],
            labelFileCountPlural: ["فایل‌ها در لیست", ge.STRING],
            labelFileLoading: ["در حال بارگذاری", ge.STRING],
            labelFileAdded: ["اضافه شد", ge.STRING],
            labelFileLoadError: ["خطا در هنگام بارگذاری", ge.STRING],
            labelFileRemoved: ["حذف شد", ge.STRING],
            labelFileRemoveError: ["خطا در هنگام حذف", ge.STRING],
            labelFileProcessing: ["در حال آپلود", ge.STRING],
            labelFileProcessingComplete: ["آپلود کامل شد", ge.STRING],
            labelFileProcessingAborted: ["آپلود لغو شد", ge.STRING],
            labelFileProcessingError: ["خطا در هنگام آپلود", ge.STRING],
            labelFileProcessingRevertError: ["خطا در هنگام بازگشت", ge.STRING],
            labelTapToCancel: ["برای لغو ضربه بزنید", ge.STRING],
            labelTapToRetry: ["برای تلاش مجدد ضربه بزنید", ge.STRING],
            labelTapToUndo: ["برای لغو عملیات ضربه بزنید", ge.STRING],
            labelButtonRemoveItem: ["حذف", ge.STRING],
            labelButtonAbortItemLoad: ["لغو", ge.STRING],
            labelButtonRetryItemLoad: ["تلاش مجدد", ge.STRING],
            labelButtonAbortItemProcessing: ["لغو", ge.STRING],
            labelButtonUndoItemProcessing: ["بازگشت", ge.STRING],
            labelButtonRetryItemProcessing: ["تلاش مجدد", ge.STRING],
            labelButtonProcessItem: ["آپلود", ge.STRING],
                    ...
                    if (!T.aborted)
                        if (t = t || f.find(L)) {
                            ...
                            var n = p.ondata || function(e) {
                                ...
                                c = "function" == typeof p.headers ? p.headers(t) : Object.assign({}, p.headers, {
                                    "Content-Type": "application/offset+octet-stream",
                                    "Upload-Offset": t.offset,
                                    "Upload-Length": r.size,
                                    "Upload-Name": r.name
                                }),
                                d = t.request = rt(n(t.data), l, Object.assign({}, p, {
                                    headers: c
                                }));
                            d.onload = function(e) {
                                s(e, t.index, f.length), t.status = ct, t.request = null, w()
                    ...
                    if (M(o)) f({
                        ...
                        v.on("init", function() {
                            ...
                            v.on("metadata-update", function(t) {
                                ht(v.file) && e("DID_UPDATE_ITEM_METADATA", {
                                    id: h,
                                    change: t
                                })
    ...
    var Kt, $t = function(e) {
                ...
                t.ref.handleClick = function(e) {
                    ...
                    if (e.isPrimary) {
                        ...
                        var c = function(e) {
                            ...
                            p = function() {
                                document.removeEventListener("pointercancel", d), document.removeEventListener("pointermove", c), document.removeEventListener("pointerup", f), t.dispatch("DID_DROP_ITEM", {
                                    id: n.id,
                                    dragState: l
                        ...
                        document.addEventListener("pointercancel", d), document.addEventListener("pointermove", c), document.addEventListener("pointerup", f)
                    }
                }))
            },
            write: vn,
        ...
        Bn = function(e) {
            ...
            if (t.query("GET_TOTAL_ITEMS") > 0) {
                ...
                for (var r = t.query("GET_ACTIVE_ITEMS"), o = !1, i = 0; i < r.length; i++) r[i].status === Ie.LOAD_ERROR && (o = !0);
                t.element.setCustomValidity(o ? t.query("GET_LABEL_INVALID_FIELD") : "")
            } else {
        ...
        Zn = A({
            ...
            DID_ADD_ITEM: function(e) {
                var t = e.root,
                    ...
                    o = Ct("input");
                o.type = r ? "file" : "hidden", o.name = t.query("GET_NAME"), t.ref.fields[n.id] = o, zn(t)
            },
            DID_LOAD_ITEM: function(e) {
                var t = e.root,
                    n = e.action,
            ...
            DID_DEFINE_VALUE: function(e) {
                var t = e.root,
                    n = e.action,
                    r = Wn(t, n.id);
                r && (null === n.value ? r.removeAttribute("value") : "file" != r.type && (r.value = n.value), zn(t))
            },
        ...
        br = function(e) {
            ...
            if (t && (/textarea|input/i.test(t.nodeName) || "true" === t.getAttribute("contenteditable"))) {
        ...
        qr = S({
            create: function(e) {
                var t = e.root,
                    n = e.props;
                t.element.id = "filepond--assistant-" + n.id, r(t.element, "role", "alert"), r(t.element, "aria-live", "polite"), r(t.element, "aria-relevant", "additions")
            },
            ignoreRect: !0,
            ignoreRectUpdate: !0,
            write: A({
        ...
        $r = S({
            ...
            create: function(e) {
                ...
                if (2 === s.length) {
                    ...
                    u.className = "filepond--credits", u.href = s[0], u.tabIndex = -1, u.target = "_blank", u.rel = "noopener noreferrer nofollow", u.textContent = s[1], t.element.appendChild(u), t.ref.credits = u
                }
            },
            write: function(e) {
                var t = e.root,
