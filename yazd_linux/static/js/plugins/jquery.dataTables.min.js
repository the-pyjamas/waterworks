...
(function(l) {
    ...
    u.defaults = {
        ...
        oLanguage: {
          oAria: {
              sSortAscending: ": فعال‌سازی برای مرتب‌سازی صعودی ستون",
              sSortDescending: ": فعال‌سازی برای مرتب‌سازی نزولی ستون"
          },
          oPaginate: {
              sFirst: "اولین",
              sLast: "آخرین",
          ...
          sInfoEmpty: "نمایش ۰ تا ۰ از ۰ مورد",
          ...
          sSearchPlaceholder: "",
          sUrl: "",
          sZeroRecords: "هیچ رکوردی مطابق یافت نشد"
      },      
