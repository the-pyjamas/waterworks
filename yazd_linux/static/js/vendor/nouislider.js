(function () {
    ...
    /* purple colored slider */
    var sliderPurpleColored = document.getElementById('purple-colored-slider');
    noUiSlider.create(sliderPurpleColored, {
        start: [50],
        step: 1,
        connect: [true, false],
        range: {
    ...
    /* slateblue colored slider */
    var sliderSlatblueColored = document.getElementById('slateblue-colored-slider');
    noUiSlider.create(sliderSlatblueColored, {
        start: [50],
        step: 1,
        connect: [true, false],
        range: {
    ...
    /* teal colored slider */
    var sliderTealColored = document.getElementById('teal-colored-slider');
    noUiSlider.create(sliderTealColored, {
        start: [50],
        step: 1,
        connect: [true, false],
        range: {
    ...
    /* orange colored slider */
    var sliderOrangeColored = document.getElementById('orange-colored-slider');
    noUiSlider.create(sliderOrangeColored, {
        start: [50],
        step: 1,
        connect: [true, false],
        range: {
    ...
    /* light colored slider */
    var sliderLightColored = document.getElementById('light-colored-slider');
    noUiSlider.create(sliderLightColored, {
        start: [50],
        step: 1,
        connect: [true, false],
        range: {
    ...
    /* dark colored slider */
    var sliderDarkColored = document.getElementById('dark-colored-slider');
    noUiSlider.create(sliderDarkColored, {
        start: [50],
        step: 1,
        connect: [true, false],
        range: {
