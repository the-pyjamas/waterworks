! function() {
    ...
    var p = {
            ...
            renameFile: null,
            forceFallback: !1,
            dictDefaultMessage: "فایل‌ها را اینجا رها کنید تا آپلود شوند",
            dictFallbackMessage: "مرورگر شما از آپلود فایل به روش کشیدن و رها کردن پشتیبانی نمی‌کند.",
            dictFallbackText: "لطفاً از فرم جایگزین زیر برای آپلود فایل‌های خود مانند گذشته استفاده کنید.",
            dictFileTooBig: "فایل بیش از حد بزرگ است ({{filesize}} مگابایت). حداکثر اندازه فایل: {{maxFilesize}} مگابایت.",
