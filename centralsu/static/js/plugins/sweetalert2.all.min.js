...
! function(e, t) {
    ...
    const zt = {
            ...
            closeButtonAriaLabel: "بستن این پنجره",
            loaderHtml: "",
    ...
    var qn = (e, t) => /^[a-zA-Z0-9.+_'-]+@[a-zA-Z0-9.-]+\.[a-zA-Z0-9-]+$/.test(e) ? Promise.resolve() : Promise.resolve(t || "آدرس ایمیل نامعتبر"),
    ...
    })), Un.DismissReason = ze, Un.version = "11.22.0";
    const Qn = Un;
